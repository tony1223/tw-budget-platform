...
var PaginationBoxView = React.createClass({
  ...
  render: function render() {
    ...
    var prevurl = this.props.pageLinkGenerator(prev);

    var nextpage = this.state.selected + 2;
    if(nextpage > this.props.pageNum){
      nextpage = this.props.pageNum;
    }
    var nexturl = this.props.pageLinkGenerator(nextpage);
    ...
    return React.createElement(
      ...
      React.createElement(PaginationListView, {
        ...
        pageLinkGenerator:this.props.pageLinkGenerator,
